...
class FrnController extends Controller
{
     ...
     *
     * @return View Returns a view populated with a collection of all FRNs.
     */
     ...
     *
     * @return View Returns the FRN creation view, passing a list of eligible lots.
     */
    ...
    public function storeWeb(Request $request)
    {
        try {
            ...
            $validated['frn_number'] = 'FRN-'.now()->format('YmdHis').'-'.str_pad((string) random_int(0, 9999), 4, '0', STR_PAD_LEFT);
